...
export default async function SupportPage({ searchParams }: SupportPageProps) {
  ...
  const osVersion = params.os_version;
  let bugReportLink =
  ...
  if (appVersion) {
    bugReportLink = bugReportLink.replaceAll("APP_VERSION", appVersion);
  }
  if (osVersion) {
    bugReportLink = bugReportLink.replaceAll("OS_VERSION", osVersion);
  }
  return (
