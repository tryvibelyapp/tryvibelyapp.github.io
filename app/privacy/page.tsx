...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Vibely.",
  alternates: {
    canonical: "/privacy",
  },
};
  ...
  return (
    <div className="flex flex-col gap-6 text-zinc-900 dark:text-zinc-100">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        via our app, Vibely - Music Visualizer, and its associated services.
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        This policy is effective as of 21 December 2021.
      </p>
      ...
      <ul className="max-w-2xl list-disc ml-6 space-y-2 text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        <li>
          ...
          providers, advertising providers, professional advisors, and payment
          systems operators
        </li>
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        particular service or offer, we will not deny you goods or services.
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        We will not charge different prices or rates, impose penalties, or
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        will take to deal with your complaint.
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        using the facilities provided in the communication.
      </p>
      <h3 className="text-xl font-semibold mt-6">Use of Cookies</h3>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        servers to recognise your device.
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        experience based on your preferences, and to serve advertising.
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        Please refer to our Cookie Policy for more information.
      </p>
      <h3 className="text-xl font-semibold mt-6">Business Transfers</h3>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        your personal information, among the assets transferred.
      </p>
      <h3 className="text-xl font-semibold mt-6">Limits of Our Policy</h3>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        Our app may link to external sites that are not operated by us. We have
        no control over the content and policies of those sites.
      </p>
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        to our business processes, practices, or legislative changes.
      </p>
      <h3 className="text-xl font-semibold mt-6">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        Where disclosure is solely subject to Australian privacy laws, some
        third parties may not be regulated by the Privacy Act and Australian
        Privacy Principles.
      </p>
      <h3 className="text-xl font-semibold mt-6">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        or household purposes, you may ask us about information released for
        marketing purposes.
      </p>
      <h4 className="text-lg font-semibold mt-4">Do Not Track</h4>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
      ...
      <h4 className="text-lg font-semibold mt-4">Cookies and Pixels</h4>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        You may decline cookies from our site if your browser permits. Please
        refer to the Cookies section of this policy for more information.
      </p>
      <h4 className="text-lg font-semibold mt-4">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        different prices, rates, or quality levels.
      </p>
      <h4 className="text-lg font-semibold mt-4">
      ...
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        receive information from, review the Information We Collect section.
      </p>
      <h4 className="text-lg font-semibold mt-4">Right to Know and Delete</h4>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        data practices in the preceding 12 months.
      </p>
      <ul className="max-w-2xl list-disc ml-6 space-y-2 text-base leading-7 text-zinc-600 dark:text-zinc-400">
        <li>
      ...
      <h4 className="text-lg font-semibold mt-4">Shine the Light</h4>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        If you are a California resident, you have the right to request
        information regarding how we share certain personal information for
        direct marketing purposes.
      </p>
      <h3 className="text-xl font-semibold mt-6">Contact Us</h3>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        For any questions or concerns regarding your privacy, contact:
      </p>
      <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
        Aibek Mazhitov
        <br />
